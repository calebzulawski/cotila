...
static_assert(cotila::abs(std::complex(3.,4.)) == 5.);

static_assert(cotila::abs(-4) == 4);

static_assert(cotila::abs(4) == 4);

static_assert(cotila::conj(4) == 4);

static_assert(cotila::conj(-4) == -4);

static_assert(cotila::conj(std::complex(3,4)) == std::complex(3,-4));
